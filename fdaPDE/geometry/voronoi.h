...
template <> class Voronoi<Triangulation<2, 2>> {
   public:
    ...
    const BinaryVector<fdapde::core::Dynamic>& boundary_vertices() const { return nodes_markers_; }
   ...
   private:
    ...
    BinaryVector<fdapde::core::Dynamic> nodes_markers_;       // i-th element true if i-th vertex is on boundary
